...
<html lang="es">
    <head>
        <meta charset="utf-8"/> <!-- meta es solamente metadata de los sitios utilizado por el motor de busqueda utilizado-->
        <title>Bazar JORFER | Tienda</title>
        <meta name="description" content="Tienda en linea del Bazar JORFER"/>
