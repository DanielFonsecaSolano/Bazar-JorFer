                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <img src="./public/img/categori/product6.png" alt="" class="img-fluid">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <img src="./public/img/categori/product2.png" alt="" class="img-fluid">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <img src="./public/img/categori/product5.png" alt="" class="img-fluid">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <img src="./public/img/categori/product1.png" alt="" class="img-fluid">
                                    <h3> <a href="single-product.html">Memory foam filling cotton Slow rebound pillows</a> </h3>
                                    <p>From $5</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <img src="./public/img/categori/product4.png" alt="" class="img-fluid">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <img src="./public/img/categori/product3.png" alt="" class="img-fluid">
                                    <h3> <a href="single-product.html">Sleeping orthopedic sciatica Back Hip Joint Pain relief</a> </h3>
                                    <p>From $5</p>
                                </div>
                            </div>
                    ...
                    <div class="client_review_slider owl-carousel">
                        <div class="single_client_review">
                            <div class="client_img">
                                <img src="./public/img/client.png" alt="#">
                            </div>
                        ...
                        <div class="single_client_review">
                            <div class="client_img">
                                <img src="./public/img/client_1.png" alt="#">
                            </div>
                            <p>"Working in conjunction with humanitarian aid agencies, we have supported programmes to help alleviate human suffering.</p>
                            <h5>- Micky Mouse</h5>
                        </div>
                        <div class="single_client_review">
                            <div class="client_img">
                                <img src="./public/img/client_2.png" alt="#">
                            </div>
                            <p>"Working in conjunction with humanitarian aid agencies, we have supported programmes to help alleviate human suffering.</p>
                            <h5>- Micky Mouse</h5>
                        </div>
